...
table_quantity = store[goods['Стол']][1]['quantity'] + store[goods['Стол']][0]['quantity']
table_price = store[goods['Стол']][0]['price'] + store[goods['Стол']][1]['price']
table_cost = table_quantity * table_price
print('Стол -', table_quantity, 'шт, стоимость', table_cost,'руб')

sofa_quantity = store[goods['Диван']][0]['quantity'] + store[goods['Диван']][1]['quantity']
sofa_price = store[goods['Диван']][0]['price'] + store[goods['Диван']][1]['price']
